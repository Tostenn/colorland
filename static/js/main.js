 ...
 * 
 * @param {Number} op si cet argument est define il fait varie l'oppacité
 * @returns {Array} une couleur en RGBa 
 */
export function couleurs(op = false){
    ...
    op = op ? op : Math.round(Math.random()*5)
    const color = [x,y,z,op]
    return color
}
